...
export default function ProfileCard({ profile, gameProfile, game }) {
  ...
  return (
    <Link
      ...
      className="flex flex-col overflow-hidden rounded-xl border border-surface-border bg-surface-soft transition hover:border-yang-300/50 hover:bg-surface-border/60"
    >
      <ProfileBanner profile={profile} className="h-14" />
